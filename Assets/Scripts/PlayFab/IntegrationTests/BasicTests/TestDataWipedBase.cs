...
namespace IdleFantasy.PlayFab.IntegrationTests {
    public abstract class TestDataWipedBase : IntegrationTestBase {
        ...
        protected IEnumerator DeleteAllPlayerSaveData() {
        ...
        protected IEnumerator VerifyPlayerSaveDataIsEmpty() {
        ...
        protected IEnumerator AddMissingSaveData() {
        ...
        protected IEnumerator VerifySaveDataIsDefault() {
